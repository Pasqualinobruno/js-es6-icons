...
const select_animal = document.querySelector(".animal").textContent;
//console.log(select_animal);

const select_vegetable = document.querySelector(".vegetable").textContent;
//console.log(select_vegetable);

const select_user = document.querySelector(".user").textContent;
//console.log(select_user);



const animali = animals.filter(animal => animal.type === select_animal);
//console.log(animali);

const vegetali = animals.filter(animal => animal.type === select_vegetable);
//console.log(vegetali);

const utenti = animals.filter(animal => animal.type === select_user);
//console.log(utenti);
console.log(animals);


const for_card = document.querySelector('#for_crad_animal');

(animali) + (vegetali) + (utenti).forEach(animal => {
    //console.log(animal);

    animal = `
    <div class="cards col-2">
        <i class=" ${animal.family}  ${animal.prefix + animal.name}" style="color: ${animal.color} ;" ></i>
        <div>${animal.name}</div>
    </div>
    `
    //console.log(animal);
    for_card.insertAdjacentHTML('beforeend', animal)
